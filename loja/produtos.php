            ...
            <div class="col-lg-4">
              <div class="product__discount__item">
               ...
               <div class="product__discount__item__text">
                ...
                <div class="product__item__price"><span class="mr-1">R$ <?php echo $valor_old ?></span> R$ <?php echo $valor ?> </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-4">
        <div class="product__discount__item">
         ...
         <div class="product__discount__item__text">
          ...
          <h5><a href="produto-<?php echo $nome_url ?>"><?php echo $nome ?></a></h5>
          <div class="product__item__price"><span class="mr-1">R$ <?php echo $valor ?></span> R$ <?php echo $valor_promo ?> </div>
        </div>
      </div>
    </div>
