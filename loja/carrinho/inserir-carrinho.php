...
if(@$_SESSION['hora_compra'] == ""){
	@$_SESSION['hora_compra'] = date('d-m-Y H:i:s');
}
...
$pdo->query("INSERT INTO carrinho(id_usuario, id_produto, quantidade, id_venda, data, combo, sessao) values ('$id_cliente', '$id_produto', '$quantidade', '0', curDate(), '$combo', '$sessao')");
