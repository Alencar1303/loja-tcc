            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__price">
                        <?php 
                        if($promocao == 'Sim'){
                           echo '<small><small><span class="text-muted"><s>R$ '.$valor_antigo . '</s></span></small></small> '; 
                        }
                         ?>
                        R$ <?php echo $valor ?>
                    ...
                    <small><div id="div-mensagem-prod"></div></small>
                        ...
                        <div class="row mt-4 mb-4 ml-1">
                            ...
                            <div class="mr-3 mt-2">
                                ...
                                $query4 = $pdo->query("SELECT * from carac_itens where id_carac_prod = '$id_carac_prod' and ativo != 'Não'");
