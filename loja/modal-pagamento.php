            ...
            <div class="modal-body">
               ...
               <div class="row">
                      ...
                      <div class="col-md-4 col-sm-12 mb-1">
                        ...
                        $btn = $pagar->PagarMP($id_venda, $nome_produto, (float)$vlr_venda_sem_format, $url_loja);
                         echo $btn;
                         ?>
                      ...
                      <div class="row mt-4">
                       <div class="col-md-12">
                        ...
                        <small> Se já efetuou o pagamento <a title="Ir para o Painel" href="sistema/painel-cliente/index.php?pag=pedidos" class="text-success" target="_blank">Clique aqui</a> </small>
